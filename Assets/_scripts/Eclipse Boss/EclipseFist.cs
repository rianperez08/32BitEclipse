...
//    Eclipse
//}
//public class EclipseFist : MonoBehaviour
//{
...
//        Vector3 currentPositioin = spline.EvaluatePosition(distancePercentage);
//        transform.position = currentPositioin;
//    }   
//
//    #endregion
//
...
//        {
//            if (smash_count >= 2) UpdateEnemyState(FistState.Stuck);
//            else UpdateEnemyState(FistState.Return);
//        }
//    }
//    #endregion
//
...
//        if (Vector3.Distance(initial_pos, transform.position) <= .001f) UpdateEnemyState(FistState.Eclipse);
//    }
//    #endregion
//
//    #region Shoot
